                ...
                if(spellClear[0] == true && spellClear[1] == true && spellClear[2] == true)
                    {
                        ...
                        confirmButton.onclick = function()
                        {
                            for(let i = 1; i<=3; i++)
                                {
                                    //My_Spells
                                    document.getElementsByClassName("MySpell")[i-1].innerHTML = '<img title="'+YourSpellsList[i-1][0]+'" width="50" height="50"   src="'+document.getElementById("pi"+i).getAttribute('src')+'" alt="'+document.getElementById("pi"+i).getAttribute('alt')+'"><div class="partialAttack p10">10</div><div class="partialAttack p40">40</div><div class="partialAttack p70">70</div>';
                                                        ...
                                                        if(document.getElementById("enemyLive").value > 500)
                    {
                    ...
                    else if(EnemyRandomTableAttackIndex > 3)
                        {
                            ...
                            document.getElementById("oa").onclick = function()
                            {
                                ...
                                for(let i=0; i<3; i++)
                                    {
                                        ...
                                        spellClear[i] = false;
                                        YourSpellsList[i][2] = true;
                                        Spells[x[i]].classList.remove("unavaibleSpells");
                                        Spells[x[i]].classList.add("avaibleSpells");
                                    }
                                document.getElementById("confirmButton").removeAttribute("class", "confirm");
                                document.getElementById("confirmButton").setAttribute("class", "unconfirm");
                                ...
                                MyMana = 100; mm = 100;
                                MyLive = 1000; ml = 1000;
                                EnemyMana = 100; em = 100;
                                EnemyLive = 1000; el = 1000;
                                ...
                                for(let i=0; i<5; i++)
                                    {
                                        YourSpellsList[i] = null;
                                        EnemySpellsList[i] = null;
                                    }
                                for(let i=0; i<3; i++)
                                    {
                                        document.getElementsByClassName("MySpell")[i].innerHTML = " ";
                                        document.getElementsByClassName("my_enemy_spell")[i].innerHTML = " ";
                                    }
                                //PLAN_3
